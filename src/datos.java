...
public class datos {
    ...
    // Conectar a la base
    static final String DB_URL = "jdbc:sqlserver://1-21-01-E019-20\\MSSQLSERVER01:57520;database=correccion;encrypt=true;trustServerCertificate=true;";
    static final String USER = "usuario"; // Usuario de SQL Server
    static final String PASS = "123"; // Contraseña de SQL Server
    ...
    public static void conectar(){
        try{
            final String DB_URL="jdbc:sqlserver://1-21-01-E019-20\\MSSQLSERVER01:57520;database=correccion;encrypt=true;trustServerCertificate=true;";
